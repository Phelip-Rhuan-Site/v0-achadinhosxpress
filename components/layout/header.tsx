        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-md">
            <div className="relative w-full">
              ...
              <Input
                ...
                className="pl-10 bg-background/50 border-primary/20 text-foreground"
              />
            </div>
          </form>
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-40 bg-card border-primary/20">
                <DropdownMenuItem
                ...
                <DropdownMenuItem
                  ...
                  className={`cursor-pointer ${language === "fr" ? "bg-primary/10" : ""}`}
                >
                  🇫🇷 Français
                </DropdownMenuItem>
                <DropdownMenuItem
                  onClick={() => setLanguage("de")}
                  className={`cursor-pointer ${language === "de" ? "bg-primary/10" : ""}`}
                >
                  🇩🇪 Deutsch
                </DropdownMenuItem>
                <DropdownMenuItem
                  onClick={() => setLanguage("zh")}
                  className={`cursor-pointer ${language === "zh" ? "bg-primary/10" : ""}`}
                >
                  🇨🇳 中文
                </DropdownMenuItem>
                <DropdownMenuItem
