...
export function ProductModal({ product, open, onClose, onAddToCart }: ProductModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-7xl max-h-[98vh] overflow-y-auto bg-card border-primary/20 p-0">
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-4">
            <div className="relative w-full aspect-video bg-background rounded-lg overflow-hidden border border-primary/10">
              <Image
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            {/* Price and Store */}
            <div className="flex items-center justify-between">
              <p className="text-4xl font-bold text-primary">{formatPrice(product.price, language)}</p>
            ...
            {/* Description */}
            <div>
              <h3 className="text-xl font-semibold text-foreground mb-3">Descrição</h3>
              <p className="text-foreground leading-relaxed whitespace-pre-wrap text-lg">{product.description}</p>
            </div>
            ...
            <div className="flex flex-col gap-3 pt-4 sticky bottom-0 bg-card pb-4">
              <Button
                size="lg"
                className="w-full bg-primary text-primary-foreground hover:bg-primary/90 text-lg h-14 transition-all hover:scale-[1.02]"
                onClick={handleBuy}
              >
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-primary/20 text-foreground hover:bg-primary/10 bg-transparent transition-all hover:scale-[1.02] h-12"
                  onClick={() => {
                    onAddToCart(product)
                    toast({
